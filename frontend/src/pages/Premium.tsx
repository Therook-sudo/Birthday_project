...
<div className="min-h-screen bg-background">
      ...
      <main className="container flex min-h-[70vh] items-center justify-center py-12">
        <motion.div
          ...
          className="mx-auto max-w-2xl rounded-2xl border border-border bg-card p-8 text-center shadow-soft"
        >
          ...
          <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
            We are working on premium birthday services, including personalized
            wish delivery, voice notes, video messages, and more.
          </p>
          ...
          <div className="mt-6 rounded-xl border border-border bg-muted/40 p-4">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Please check back later once Premium has been enabled.
            </p>
          </div>
